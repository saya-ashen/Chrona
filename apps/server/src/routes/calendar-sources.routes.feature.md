...
Missing or weak:
- Route behavior appears exercised only transitively by API tests; without generated direct tests here, request validation, status mapping, and error branches remain unproven for this feature doc.
<!-- ai:end -->
