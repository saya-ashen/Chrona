...
vi.mock("@/components/schedule/panels/selected-block-sheet/use-selected-block-plan-state", () => ({
...
vi.mock("@/components/schedule/panels/selected-block-sheet/use-selected-block-config-state", () => ({
