...
import { intentLabel, nodeKindLabel } from "./logic";
    ...
    <aside className="rounded-[24px] border border-border/70 bg-background/96 p-4 shadow-[0_18px_48px_rgba(15,23,42,0.16)] backdrop-blur">
      <div className="border-b border-border/60 pb-4">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <span className="rounded-full bg-foreground/6 px-2 py-1 text-[10px] uppercase tracking-[0.14em] text-muted-foreground">{intentLabel(node.intent, graphCopy)}</span>
        </div>
