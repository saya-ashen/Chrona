...
const DEFAULT_COPY = {
  title: "Recent Task Records",
  noEventsYet: "No task records yet. They will appear once the task starts or new progress occurs.",
  progress: "Task Records",
  rawPayload: "View Raw Record",
  noStructuredPayload: "No structured records available.",
  itemSingular: "item",
  itemPlural: "items",
  details: "Details",
  prioritizedSection: "Priority Review",
  backgroundSection: "Background Records",
  latestActivity: "Latest Activity",
  keyMilestones: "Key Milestones",
  attentionNeeded: "Needs Attention",
  expandBackground: "Expand {count} more background records",
  collapseBackground: "Collapse background records",
  backgroundHint: "These records are for tracing context; collapsed by default to avoid overwhelming the key milestones.",
  linkedEvidence: "Linked Evidence",
  currentRunGroup: "Current Run",
  previousRunGroupPrefix: "Previous Run",
