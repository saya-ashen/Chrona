...
export function TaskPlanGraphPanel({
  ...
  return (
    <div className={cn("flex min-w-0 flex-col rounded-[1rem] border border-border/40 bg-background/60 p-1.5 shadow-none", fillHeight && "h-full min-h-0", className)}>
      <div className="mb-1.5 flex min-w-0 items-start justify-between gap-2 px-1">
