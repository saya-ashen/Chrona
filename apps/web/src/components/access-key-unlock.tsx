				...
				<div className="mb-6 flex items-start gap-4">
					...
					<div>
						<p className="text-xs font-semibold uppercase tracking-[0.24em] text-primary">
							{t("components.accessKeyUnlock.eyebrow")}
						</p>
						<h1 className="mt-2 text-2xl font-semibold tracking-tight text-foreground">
							{t("components.accessKeyUnlock.title")}
						</h1>
						<p className="mt-2 text-sm leading-6 text-muted-foreground">
							{t("components.accessKeyUnlock.description")}
						</p>
					</div>
				</div>
						...
						<Controller
							...
							render={({ field }) => (
								<Field
									...
									className="rounded-2xl border border-border/70 bg-muted/50 p-3 text-sm text-muted-foreground"
								>
									<Checkbox
										id="remember-access-key"
										checked={field.value}
									...
									<FieldContent>
										<FieldLabel
											htmlFor="remember-access-key"
											className="font-medium text-foreground"
										>
											{t("components.accessKeyUnlock.rememberLabel")}
										</FieldLabel>
										<FieldDescription>
											{t("components.accessKeyUnlock.rememberHint")}
										</FieldDescription>
									</FieldContent>
								</Field>
							)}
