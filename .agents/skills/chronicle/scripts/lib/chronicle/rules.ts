...
import type { ChronicleRules } from "./types";
...
export function loadRules(path = "docs/maps/chronicle.rules.yaml"): ChronicleRules {
  return RulesSchema.parse(parseYamlLike(fs.readFileSync(path, "utf8"))) as ChronicleRules;
}
