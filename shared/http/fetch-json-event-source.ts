...
import { buildAccessKeyHeaderRecord, handleUnauthorizedResponse } from "./access-key";

export type JsonEventSourcePayload = Record<string, unknown>;

export type JsonEventSourceEvent = {
  event: string;
  data: JsonEventSourcePayload;
  message: EventSourceMessage;
};

export type JsonEventSourceOptions = Omit<
