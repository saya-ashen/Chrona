...
- In this monorepo, also check the relevant `apps/<context>/docs/adr/` or `packages/<context>/docs/adr/` directory for context-scoped decisions.
...
Chrona uses a multi-context layout:
