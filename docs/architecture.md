...
Inbox aggregates attention items: approvals, schedule proposals, waiting inputs, failed runs, and cancelled runs.
...
The public HTTP API is grouped by tasks, plans, execution, schedule, pages, workspaces, runtime providers, AI clients, assistant surface, and MCP. See `docs/api-reference.md`.
