...
export function ControlPlaneShell({ children }: ControlPlaneShellProps) {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-[linear-gradient(180deg,rgba(15,23,42,0.03),transparent_22%),linear-gradient(135deg,rgba(59,130,246,0.05),transparent_35%),linear-gradient(225deg,rgba(168,85,247,0.04),transparent_30%)] bg-background text-foreground">
