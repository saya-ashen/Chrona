...
describe("resolveApproval", () => {
  ...
  it("marks edited approval resolved and clears the task blocker locally", async () => {
    const workspace = await db.workspace.create({
      data: {
  ...
  it("marks a rejected approval as failed without upstream runtime fallback", async () => {
    const workspace = await db.workspace.create({
      data: {
