...
const FINALIZED_RESULT_REVIEW_INSTRUCTIONS = [
	...
	"Correct omissions of primary result content, duplicated facts, weak first-viewport priorities, misleading readiness, inappropriate component choices, excessive card repetition, and raw evidence that should be subordinate.",
