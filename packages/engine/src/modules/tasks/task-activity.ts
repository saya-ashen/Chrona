...
export function orderActivityNewestFirst(items: WorkspaceActivityTimelineItem[]) {
...
export function mapTimelineItemToActivity(item: TaskTimelineActivityItem): WorkspaceActivityTimelineItem {
  return taskActivityItem({
    id: item.id,
