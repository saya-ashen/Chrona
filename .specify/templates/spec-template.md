...
- **SC-005**: [Performance metric or budget, e.g., "P95 API response remains under 200 ms for this workflow"]
- **SC-006**: [Consistency metric, e.g., "All affected screens reuse the existing state and copy patterns with no accessibility regressions"]
