  ...
  return (
    <Card size="sm" className="border-transparent bg-brand-peach/80 py-4" data-ui-surface-kind="product-authored">
      ...
      <CardContent className="space-y-3 px-4 text-xs">
        ...
        {summary.changeSummary ? <div className="rounded-2xl border border-background/70 bg-background/60 p-3"><p className="font-semibold text-foreground">Plan diff review</p><p className="mt-1 text-foreground/70">{summary.changeSummary}</p></div> : null}
