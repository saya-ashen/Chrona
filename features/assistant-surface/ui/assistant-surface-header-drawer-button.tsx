...
export function AssistantSurfaceHeaderDrawerButton({ disabled = false }: AssistantSurfaceHeaderDrawerButtonProps) {
  ...
  return (
    <button
      ...
      className={cn(
        "group hidden h-9 max-w-[520px] scroll-mb-24 items-center gap-2 overflow-hidden rounded-full border border-border/60 bg-muted/40 px-2.5 text-sm transition-colors md:inline-flex",
        disabled
