...
export function useExecutionOverviewOutput({
  ...
  }), [artifacts, commandCenter?.documents.output, currentExecution?.planOutput?.updatedByNodeId, latestCompletedNode, nodeOptions, resultSpec, selectedNodeId, workspaceCopy]);
