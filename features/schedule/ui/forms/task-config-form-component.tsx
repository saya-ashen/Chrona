...
const DEFAULT_COPY = {
  moreOptions: "More options", starterPresets: "Starter presets", title: "Title", basics: "Basics", titlePlaceholder: "Add the next task to execute", priority: "Priority", schedule: "Schedule", scheduleHint: "Adjust when this block should run.", scheduleDate: "Date", scheduleStart: "Start", scheduleEnd: "End", scheduleDuration: "Duration",
