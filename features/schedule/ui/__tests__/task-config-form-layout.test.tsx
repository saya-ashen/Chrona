...
import { TaskConfigForm } from "../forms/task-config-form";
...
describe("TaskConfigForm – field layout", () => {
  ...
  it("renders source calendar description inside the description section", () => {
    render(
      <TaskConfigForm
        {...defaultProps}
        sourceDescription="Discuss sync blockers and handoff notes."
        sourceDescriptionLabel="Calendar description · Team calendar"
      />,
    );
