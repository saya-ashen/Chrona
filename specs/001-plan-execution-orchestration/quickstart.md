...
4. Confirm whether a route or module is provider-neutral or still Hermes-specific.
...
3. Remove remaining Hermes leakage from route/runtime orchestration paths.
