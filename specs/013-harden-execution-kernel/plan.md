...
- **Frontend UX Evidence**: PASS with no visual redesign planned. If implementation changes visible task/node status wording or activity history rows, use before and after those UI changes and verify desktop `1440x900`, tablet `1024x768`, and mobile `390x844` with no horizontal scrolling.
