...
1. Capture current UX evidence with before UI edits.
...
11. Run post-edit at desktop `1440x900`, tablet `1024x768`, and mobile `390x844`.
...
- 2026-05-19: Updated dropdown layout verification captured with after centering the trigger and widening the dropdown panel:
