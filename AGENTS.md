...
`specs/008-task-orchestrator/plan.md`
...
This project is indexed by GitNexus as **Chrona** (7135 symbols, 13282 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
