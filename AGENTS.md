...
`specs/003-task-workspace-components/plan.md`
...
This project is indexed by GitNexus as **Chrona** (6486 symbols, 12232 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
