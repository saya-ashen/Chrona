...
This project is indexed by GitNexus as **Chrona** (9490 symbols, 16919 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
