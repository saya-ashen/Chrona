...
This project is indexed by GitNexus as **Chrona** (6431 symbols, 11630 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
